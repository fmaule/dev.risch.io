...
const initMap = () => {
  ...
  const covidRisk = [{ istatId: 1, risk: 2 }, { istatId: 2, risk: 2 }, { istatId: 3, risk: 2 }, { istatId: 4, risk: 2 }, { istatId: 5, risk: 1 }, { istatId: 6, risk: 0 }, { istatId: 7, risk: 1 }, { istatId: 8, risk: 0 }, { istatId: 9, risk: 0 }, { istatId: 10, risk: 0 }, { istatId: 11, risk: 0 }, { istatId: 12, risk: 0 }, { istatId: 13, risk: 0 }, { istatId: 14, risk: 0 }, { istatId: 15, risk: 1 }, { istatId: 16, risk: 1 }, { istatId: 17, risk: 0 }, { istatId: 18, risk: 2 }, { istatId: 19, risk: 0 }, { istatId: 20, risk: 0 }];
  ...
  fetch('data/limits_IT_regions.topo.json').then(response => response.json()).then(data => {
    console.log({ data });
    addTopoData(data);
  });
